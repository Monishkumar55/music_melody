class Song {
  ...
  factory Song.fromJson(Map<String, dynamic> json) {
    ...
    return Song(
      ...
      album: json['album'] ?? json['movie'] ?? 'Single',
      language: json['language'] ?? 'Tamil',
      genre: json['genre'] ?? 'Film Song',
      year: json['year'] is int ? json['year'] : (json['release_year'] is int ? json['release_year'] : int.tryParse(json['year']?.toString() ?? '')),
      duration: json['duration'] is int ? json['duration'] : int.tryParse(json['duration']?.toString() ?? ''),
      coverImage: json['coverImage'] ?? json['cover_image'] ?? json['image'] ?? 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500&auto=format&fit=crop',
      audioUrl: (json['audioUrl'] is String && (json['audioUrl'] as String).isNotEmpty) ? json['audioUrl'] : (json['file_url'] is String ? json['file_url'] : null),
      moodTags: json['moodTags'] ?? json['mood'] ?? 'romantic',
